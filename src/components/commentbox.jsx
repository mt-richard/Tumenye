...
const Commentbox = (props) => {
    return (
        <div>
            <div className="m-2 commentbox flex rounded bg-gray-300 rounded-r-xl rounded-b-xl">
                ...
                <div className="content p-5 pt-1">
                    ...
                    <p className='text-[14px] md:text-[16px] font-light pt-2 md:pl-5'>{props.comment}</p>
                </div>
            </div>
        </div>
    )
